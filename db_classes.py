...
class Subject(BASE):
    ...
    start_time_stamp_nanos = Column(BigInteger)
    unit_id = Column(Integer)
    iteration = Column(Integer)
    count = Column(Integer)
    cmd_line = Column(String(65535))
    privilege_level = Column(String(256))
    imported_libraries = Column(String(65535))
    exported_libraries = Column(String(65535))
...
class Event(BASE):
    ...
    predicate_object = Column(String(256))
    prediacte_object_path = Column(String(4095))
    predicate_object_2 = Column(String(256))
    predicate_object_path_2 = Column(String(4095))
    time_stamp_nanos = Column(BigInteger)
...
class NetFlowObject(BASE):
    ...
    base_object_host_id = Column(String(256))
    base_object_permission = Column(Integer)
    local_address = Column(String(256))
    local_port = Column(Integer)
    remote_address = Column(String(256))
